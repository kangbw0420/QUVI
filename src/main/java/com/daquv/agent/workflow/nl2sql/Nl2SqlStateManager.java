...
public class Nl2SqlStateManager {
    private final ConcurrentHashMap<String, Nl2SqlWorkflowState> chainStates = new ConcurrentHashMap<>();
     ...
     * 새 State 생성
     */
    public Nl2SqlWorkflowState createState(String workflowId) {
        Nl2SqlWorkflowState state = Nl2SqlWorkflowState.builder()
     ...
     * State 조회
     */
    public Nl2SqlWorkflowState getState(String workflowId) {
        if (workflowId == null) {
            return null;
        }
     ...
     * State 업데이트
     */
    public void updateState(String workflowId, Nl2SqlWorkflowState state) {
