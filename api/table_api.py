...
from api.dto import PostgreToVectorData, VectorDataQuery, PromptInput, FewshotInput, TableRequest
from database.database_service import DatabaseService

table_api = APIRouter(tags=["table"])


# 컬럼명 관리 데이터 전체 조회
@table_api.get("/table/getAll")
def get_all_table():
    """
...
#
# # Prompt 데이터 추가
# @table_api.post("/table/add")
# def add_table(data: TableRequest):
#     """
#     새 Prompt를 추가합니다.
#     """
#     try:
#         success = DatabaseService.add_prompt(data.node_nm, data.prompt_nm, data.prompt)
#         if not success:
...
#
# # Few-shot 데이터 조회
# @table_api.get("/fewshot/get/{title}")
...
#
# # Few-shot 전체 데이터 조회
# @table_api.post("/fewshot/getAllRDB")
...
#
# # Few-shot 데이터 전체 삭제
# @table_api.delete("/fewshot/delete")
...
#
# # Few-shot 휘발데이터 복구
# @table_api.post("/fewshot/restore")
# def restore_fewshot():
#     """
