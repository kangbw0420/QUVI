...
async def response2(trace_id: str, user_question, column_list = None) -> str:
    ...
    system_prompt = database_service.get_prompt(node_nm='respondent2', prompt_nm='system')[0]['prompt']
    ...
    human_prompt = database_service.get_prompt(node_nm='respondent2', prompt_nm='human')[0]['prompt'].format(
